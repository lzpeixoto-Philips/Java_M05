 ...
 */
package com.mycompany.philips.view;
import com.mycompany.philips.model.Triangulo;
 ...
 * @author anamo
 */
public class TrianguloFX extends javax.swing.JFrame {

    /**
     * Creates new form TrianguloFX
     */
    public TrianguloFX() {
        initComponents();
        personalizarVisual();
       ...
       private void personalizarVisual() {
        ...
        // Ajustar o texto do resultado alinhado a esquerda
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);

        // Fontes dos JTextFields
        ...
        // Borda nos campos de texto
        jTextField1.setBorder(BorderFactory.createLineBorder(new Color(200, 200, 200), 1));
        jTextField2.setBorder(BorderFactory.createLineBorder(new Color(200, 200, 200), 1));
        jTextField3.setBorder(BorderFactory.createLineBorder(new Color(200, 200, 200), 1));
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (t.Validacao()) {
            jLabel5.setText(t.tipoTriangulo());
        } else {
            jLabel5.setText("Os lados não formam um triângulo.");
        }

    } catch (NumberFormatException e) {
        jLabel5.setText("Insira apenas números válidos.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrianguloFX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TrianguloFX().setVisible(true);
            }
        });
    }
